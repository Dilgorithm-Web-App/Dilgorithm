    ...
    return (
        <div className="dl-layout">
            <aside className="dl-sidebar">
                ...
                <button className={`dl-sidebar-btn ${path === '/settings' || path === '/preferences' || path === '/engagement-moderation' || path === '/app-configuration' || path === '/about-us' ? 'dl-sidebar-btn--active' : ''}`} onClick={() => navigate('/settings')} title="Settings">
